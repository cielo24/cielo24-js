...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cielo24.ErrorResponse();
  });
  ...
  describe('ErrorResponse', function() {
    it('should create an instance of ErrorResponse', function() {
      ...
      //var instance = new Cielo24.ErrorResponse();
      //expect(instance).to.be.a(Cielo24.ErrorResponse);
    });
    ...
    it('should have the property errorComment (base name: "ErrorComment")', function() {
      // uncomment below and update the code to test the property errorComment
      //var instance = new Cielo24.ErrorResponse();
      //expect(instance).to.be();
    });
